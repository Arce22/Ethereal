...
$records1 = $conn->prepare('insert into friended values( :player_id, :id)'); //where (added_id = :id and adder_id = :player_id) or (adder_id = :id and added_id = :player_id)'); // = ' .$_SESSION['company_id'].);
